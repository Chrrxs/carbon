...
int main(int argc, char *argv[]) {
    ...
    cpp_file << "    }" << endl;
    cpp_file << "    if (mod_loader) attest_loaded_build(mod_loader, false);" << endl;
    cpp_file << endl;
    cpp_file << "    return mod_loader;" << endl;
    cpp_file << "}" << endl;
    cpp_file << endl;
