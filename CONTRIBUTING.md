...
Studio with auto-recovery enabled, Rust, Node.js, Rokit, and `cargo-audit` 0.22.2. Install the
...
Full qualification launches the installed Studio stack and therefore needs
