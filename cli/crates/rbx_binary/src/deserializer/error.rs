...
pub(crate) enum InnerError {
	...
	UnknownChunkVersion { chunk_name: &'static str, version: u32 },
	...
	#[error("Strict property decoding rejected {type_name}.{prop_name}: {reason}")]
	StrictProperty {
		type_name: String,
		prop_name: String,
		reason: String,
	...
	#[error("Strict decoding rejected unknown binary chunk {name}")]
	StrictUnknownChunk { name: String },
	...
	#[error("Property decode sink failed: {0}")]
	DecodeSink(String),
}
